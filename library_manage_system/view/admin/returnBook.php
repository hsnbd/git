...
<hr>
			<div class="row">
				<div class="col-md-12">
					<div class="row">
						<div class="col-md-6">
							<label>Issue Date: </label><input type="text" name="issue_date" class="form-control" placeholder="<?php echo date("d - m - Y"); ?>">
						</div>

						<div class="col-md-6">
							<label>Return Date: </label><input type="text" name="current_date" class="form-control" placeholder="<?php echo date("d - m - Y"); ?>">
						</div>
					</div>
				</div>
			</div>
<hr>
			<div class="row">
				<div class="col-md-6 offset-md-6">
					<button type="submit" name="returnBook" class="form-control col-md-10 btn-primary">Return Book</button>
				</div>
			</div>
		</form>
	</div>
